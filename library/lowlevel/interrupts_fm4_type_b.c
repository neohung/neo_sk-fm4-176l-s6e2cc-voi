...
static void PDL_DummyHandler(uint32_t u32Caller)
{
    ...
    // 10: I2SPLL, 11: USB0_DEVICE, 12: USB0_HOST|USB0_DEVICE, 13: CANFD0, 
    // 14: CANFD1, 15: CANFD, 16: CANFD, 17: ETHER0, 18: DSTC, 
    // 19: USB1_DEVICE, 20: USB1_DEVICE, 21: USB1_HOST|USB1_DEVICE, 
    // 22: USB1_HOST|USB1_DEVICE, 23: SD0, 24: SD1, 25: ICC0, 26: ICC01, 
    // 27: SD0, 28: FLASH, 
...
/********************************** FM4: DT ***********************************/
/******************************************************************************/
#if (PDL_INTERRUPT_ENABLE_DT == PDL_ON)
/**
 ******************************************************************************
 ** \brief FM4: DT IRQ handler (IRQ#47) Type b
 ******************************************************************************/
...
/******************************************************************************/
    ...
    (PDL_INTERRUPT_ENABLE_CANFD0 == PDL_ON) || \
    (PDL_INTERRUPT_ENABLE_CANFD1 == PDL_ON) || \
    (PDL_INTERRUPT_ENABLE_CANFD == PDL_ON)
/**
 ******************************************************************************
...
void CAN1_CANFD0_IRQHandler(void)
{
    ...
    #if (PDL_INTERRUPT_ENABLE_CANFD == PDL_ON)
    if (0ul != (u32IrqMon & 0x00000008ul))
    {
...
#if (PDL_DSTC_ENABLE_BT8_IRQ0 != PDL_ON)
...
#if (PDL_DSTC_ENABLE_BT9_IRQ0 != PDL_ON)
...
#if (PDL_DSTC_ENABLE_BT10_IRQ0 != PDL_ON)
...
#if (PDL_DSTC_ENABLE_BT11_IRQ0 != PDL_ON)
...
#if (PDL_DSTC_ENABLE_BT12_IRQ0 != PDL_ON) && \
    (PDL_DSTC_ENABLE_BT13_IRQ0 != PDL_ON) && \
    (PDL_DSTC_ENABLE_BT14_IRQ0 != PDL_ON) && \
    (PDL_DSTC_ENABLE_BT15_IRQ0 != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS8_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS8_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS9_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS9_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS10_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS10_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS11_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS11_TX != PDL_ON)
...
/******************************************************************************/
    ...
    (PDL_INTERRUPT_ENABLE_SD0 == PDL_ON) || \
    (PDL_INTERRUPT_ENABLE_SD1 == PDL_ON) || \
...
void PCRC_I2S0_1_IRQHandler(void)
{
    ...
    #if (PDL_INTERRUPT_ENABLE_SD1 == PDL_ON)
    if (0ul != (u32IrqMon & 0x00000010ul))
    {
...
void ICC0_1_IRQHandler(void)
{
    ...
    #if (PDL_INTERRUPT_ENABLE_ICC01 == PDL_ON)
    if (0ul != (u32IrqMon & 0x00000010ul))
    {
...
#if (PDL_DSTC_ENABLE_MFS12_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS12_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS13_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS13_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS14_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS14_TX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS15_RX != PDL_ON)
...
#if (PDL_DSTC_ENABLE_MFS15_TX != PDL_ON)
