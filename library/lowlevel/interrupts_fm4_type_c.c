...
static void PDL_DummyHandler(uint32_t u32Caller)
{
    ...
    // 10: UPLL, 11: I2SPLL, 12: GDC_PLL, 13: USB0_DEVICE, 
    // 14: USB0_HOST|USB0_DEVICE, 15: CANFD0, 16: CANFD0, 17: CANFD0, 
    // 18: DSTC, 19: GDC, 20: GDC, 21: GDC, 22: GDC, 23: GDC, 24: GDC, 
    // 25: GDC, 26: GDC, 27: GDC, 28: GDC, 29: GDC, 30: GDC, 31: GDC, 
    // 32: GDC, 33: GDC, 34: GDC, 35: GDC, 36: GDC, 37: GDC, 38: SD0, 
    // 39: FLASH, 40: GDC, 41: GDC, 42: GDC, 43: GDC, 
...
/**
 ******************************************************************************
 ** \brief FM4: DT IRQ handler (IRQ#47) Type c
 ******************************************************************************/
...
/******************************************************************************/
    ...
    (PDL_INTERRUPT_ENABLE_GDC_SDRAM == PDL_ON)
/**
 ******************************************************************************
...
void EXTBUS_ERR_GDC_SDRAM_IRQHandler(void)
{
    ...
    #if (PDL_INTERRUPT_ENABLE_GDC_SDRAM == PDL_ON)
    if (0ul != (u32IrqMon & 0x00000002ul))
    {
...
/******************************************************************************/
    ...
    (PDL_INTERRUPT_ENABLE_GDC_PLL == PDL_ON)
/**
 ******************************************************************************
...
void TIM_IRQHandler(void)
{
    ...
    #if (PDL_INTERRUPT_ENABLE_GDC_PLL == PDL_ON)
...
/********************************** FM4: GDC **********************************/
/******************************************************************************/
#if (PDL_INTERRUPT_ENABLE_GDC == PDL_ON)
/**
 ******************************************************************************
...
/******************************** FM4: DSTC_HW ********************************/
/******************************************************************************/
#if (PDL_INTERRUPT_ENABLE_DSTC_HW == PDL_ON)
/**
 ******************************************************************************
 ** \brief FM4: DSTC_HW IRQ handler (IRQ#112) Type c
 ******************************************************************************/
